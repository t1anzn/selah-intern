...
2. A `WRITEUP.md` in the repo (keep it tight, 1-2 pages) covering:
   - The biggest tradeoff you made and why
   - Where you used AI and where it slowed you down or got things wrong
   - What you'd do with another week
   - Anything you cut

Our follow-up call is **Friday 15th May at 6pm (UK time)**. Send the repo link by **Thursday 14th May at 6pm** so we have 24 hours to read the writeup. On the call you'll share your screen, run it locally and walk us through your decisions.
...
- Don't optimise for visual polish, optimise for clarity. We won't read line-by-line. The writeup is what we read.
- If something's unclear, make a call and explain your reasoning in the writeup. Don't email asking us to clarify.
